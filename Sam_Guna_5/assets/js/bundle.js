(function() {
    ...
    1: [function(require, module, exports) {
        ...
        document.addEventListener("keypress", function(e) {
            if (99 === e.keyCode) {
                var r = document.querySelector("svg"),
                    o = r.innerHTML;
                copy('<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"> <svg width="521px" height="521px" version="1.1" baseProfile="full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ev="http://www.w3.org/2001/xml-events">' + o + "</svg>")
            }
        });
        ...
        //document.querySelector('#masker').appendChild(view.container);
    }, {
        "../index": 3,
        "copy-to-clipboard": 4
    }],
    ...
    3: [function(require, module, exports) {
        ...
        module.exports = function(t) {
            ...
            function o() {
                ...
                for (b.length = 0, t = 0; t < S.length; ++t) {
                    ...
                    if (!((c - f) * (M[3 * s + 1] - h) - (d - h) * (w - f) < 0)) {
                        ...
                        o.zIndex = g + .25 * m;
                        var N = v.join(" "); - 1 === N.indexOf("NaN") && setAttribute(p, "points", N), b.push(o)
                    }
                }
            ...
            var h = t || {},
                ...
                b = [];
            h.pxNotRatio || (p = window.innerWidth * (h.width || .25) | 0, A = 0 | (window.innerHeight * h.height || p), "minWidth" in h && p < h.minWidth && (p = h.minWidth, A = h.minWidth * h.height / h.width | 0)), setAttribute(y, "width", p + "px"), setAttribute(y, "height", A + "px"), document.querySelector('#masker').appendChild(y),
                function() {
                ...
                k = function() {
                    ...
                    return function() {
                        var c = y.getBoundingClientRect(),
                            d = c.width,
                            v = c.height;
                        if (perspective(n, Math.PI / 4, d / v, 100, 1e3), invert(a, n), l[0] = g[0], l[1] = g[1], l[2] = 1.2, transform(l, l, a), transform(l, l, o), lookAt(r, t, l, e), w) {
                            var m = Date.now() / 1e3;
    ...
    4: [function(require, module, exports) {
        ...
        function copy(e, t) {
            ...
            t || (t = {}), o = t.debug || !1;
            try {
                n = deselectCurrent(), c = document.createRange(), s = document.getSelection(), a = document.createElement("span"), a.textContent = e, a.style.all = "unset", a.style.position = "fixed", a.style.top = 0, a.style.clip = "rect(0, 0, 0, 0)", a.style.whiteSpace = "pre", a.style.webkitUserSelect = "text", a.style.MozUserSelect = "text", a.style.msUserSelect = "text", a.style.userSelect = "text", document.querySelector('#masker').appendChild(a), c.selectNode(a), s.addRange(c);
                ...
                try {
                    ...
                    o && console.error("unable to copy using clipboardData: ", n), o && console.error("falling back to prompt"), r = format("message" in t ? t.message : defaultMessage), window.prompt(r, e)
                }
            } finally {
                s && ("function" == typeof s.removeRange ? s.removeRange(c) : s.removeAllRanges()), a && document.body.removeChild(a), n()
            }
            return l
        }
